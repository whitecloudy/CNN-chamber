...
if [ $# -lt 4 ];then
  ...
  do
    ...
    do
      ...
      python3 training.py --gpunum 0 --seed $i --batch-size 256 --lr 0.001 --epochs $epochs --patience $patience --W $W --log $log_filename --model $model --aug-ratio $aug_ratio --test-batch-size 5000 --save-model #--batch-multiplier 8 --dry-run
