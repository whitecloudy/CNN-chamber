...
def training_model(args, model, device, val_data_num, do_print=False, early_stopping_patience=3):
    ...
    dataset_handler = DatasetHandler(row_size=args.W, aug_ratio=args.aug_ratio, dry_run=args.dry_run, add_noise=args.noise_add, val_noise=args.val_noise_add, postfix=args.dataset_postfix)
